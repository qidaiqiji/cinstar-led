    ...
    <div class="container">
        <div class="content-container blog-content">
            <div class="content">
                ...
                <div class="img-box">
                    <img src="https://www.cinstar-led.com/images/blog/blog2-1.jpg" alt="COB Encapsulation Technology-1">
                </div>
                <p>
                ...
                <ul class="list">
                    <li>
                        ...
                        <div class="img-box">
                            <img src="https://www.cinstar-led.com/images/blog/blog2-2.jpg" alt="COB Encapsulation Technology-2">
                        </div>
                        ...
                        <p>COB adopts high standard coating technology, which protect <a href="https://www.cinstar-led.com/">LED display</a> from any damage caused by water, moisture, dust, oxidation and UV rays etc. It supports all-weather operation and can still be running at extreme temperature condition (-30 to 80 degrees).</p>
                    </li>
                    <li>
                        ...
                        <p>
                        SMD is with better color uniformity. Before soldering, all the SMD will go through sorting machine to be divided into different batches by their brightness and color gamut etc. Only the LEDs from same batch will be used for the screen, which <a href="https://www.cinstar-led.com/products/fine-pitch-led-display.php">ensuring great color and brightness uniformity</a>. Unfortunately, such method can’t be applied to COB.
                        </p>
