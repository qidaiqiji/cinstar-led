...
<head>
    ...
    <link rel="canonical" href="https://www.cinstar-led.com/led-academy/how-to-eliminate-moire-effect-on-led-display.php">
    ...
    <div class="container">
        ...
        <div class="content-container blog-content">
            <div class="content">
                ...
                <div class="sub-title"><h2>1. Camera pixel bias technology</h2></div>
                <p>
                The moiré phenomenon is caused by the fact that the image detail is smaller than the interval of image sensors. The spatial offset imaging increases the horizontal resolution of the CCD camera as much as possible, but still cannot eliminate moiré completely, because the image sensor still has a certain spatial frequency and cannot be continuously formed into one surface.
                </p>
                ...
                <p><b>Change the focus.</b>Excessively sharp focus on detail of image will lead to moiré. But a slight adjustment in focus can change the sharpness, which in turn helps eliminate moiré.</p>
                <p><b>Change the focal length of the lens.</b>Use different lens or focal length settings to improve and eliminate moiré.</p>
