...
<head>
    ...
    <link rel="canonical" href="https://www.cinstar-led.com/led-academy/things-before-and-after-purchasing-led-display.php">
            ...
            <div class="content">
                ...
                <ul class="list">
                    <li>
                        ...
                        <p>
                        High temperatures are fatal to stability of LED displays and may cause worse safety problem, only the qualified thermal design can conduct good heat dissipation and ensuring a safe working condition for LED display. By observing the heat dissipation design of the display manufacturer, you can quickly understand whether the product is up to standard. It is recommended to start with the heat dissipation of the screen, then the cabinet, module and PCB. Taking PCB for example, 4 layers PCB performs better head dissipation than 2 layers one. And if electronic components (such as driver IC and capacitors etc) on PCB are concentrated rather than evenly placed on the whole PCB, it will cause heat dissipation issue and affect the stability and image quality of LED display.
                        </p>
                        ...
                        <p>
                        In addition to high temperature, long-term exposure in the open air, the dust and humidity in the air may cause mildew to PCB board and electronic components. Which affects the performance and service life of the equipment tremendously. Even worse, it may catch fire and lead to serious disaster. Therefore, it is critical for the owner to perform a regular cleaning and maintenance work to the LED display. 
                        </p>
                    </li>
                    <li>
