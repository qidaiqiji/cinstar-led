            ...
            <div class="content">
                ...
                <ul class="list">
                    ...
                    <li>
                        ...
                        <p>
                        Generally speaking, the outdoor LED display will be installed at the location where there is big crowd or busy traffic. Because of this characteristic, the outdoor LED screen can always get great attention with its high brightness, vivid color performance and strong visual impact. Which enables it easier to be a geographical landmark of the urban area and transmit the information to the consumers at a fixed time and fixed point repeatedly.
                        </p>
                        <p>
                            <i class="fa fa-angle-double-right"></i>
