...
<head>
    ...
    <link rel="canonical" href="https://www.cinstar-led.com/product-detail/tr-series.php">
    <link rel="stylesheet" href="../css/detail-240913.css">
    <title>Cinstar TR Series Transparent LED Mesh Display</title>
    <meta name="description" content="Cinstar transparent LED display TR series offers ultra-high transparency screens for indoor & outdoor rental. It can be used as an LED backdrop curtain on stage events and also LED mesh display for window commercial advertising.">
...
<body class="page-index .menu-open">
    ...
    <div class="container">
        <div class="detail-title tr-bg bg">
            ...
            <h1 class="top-title">Creative Effect LED Video Display Solutions</h1>
        </div>
        <!-- 产品参数 -->
        <div class="specification">
            ...
            <div class="product-img">
                <img src="https://www.cinstar-led.com/images/products/Creative-LED/TR-SERIES.jpg" alt="TR-SERIES">
            </div>
        </div>
        <!-- 产品详情 -->
        <div class="product-desc">
            <div class="left-img">
                <img src="https://www.cinstar-led.com/images/products/Creative-LED/TR-Case-Show.jpg" alt="TR-SERIES">
            </div>
        ...
        <div class="show-cases">
            ...
            <div class="img-wrap">
                <div class="caseItem">
                    <img src="https://www.cinstar-led.com/images/products/Creative-LED/tr-case-1.jpg" alt="TR-SERIES">
                    <a class="case-title">
                        <span class="current">Shopping Mall Decoration Advertising LED Screen Display</span>
                    </a>
                </div>
                <div class="caseItem">
                    <img src="https://www.cinstar-led.com/images/products/Creative-LED/tr-case-2.jpg" alt="TR-SERIES">
                    <a class="case-title">
