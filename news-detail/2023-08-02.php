...
<body class="page-index .menu-open">
    ...
    <div class="news-detail">
        <div class="content">
            <div class="news-title">
                <h1>Pilot Cinstar U1.25 configuration 5x6 LED video wall for SSS </h1>
                <h2 class="sub-title">Published：2023/08/02</h2>
            </div>
    ...
    <div class="related-news">
        <h3><span>Previous :</span><a href="2023-11-13.php">Cinstar creative LED display solutions boost your business</a></h3>
        <h3><span>Next :</span><a href="2023-05-09.php">Innovative transparent LED film screen wall debuts</a></h3>
    </div>
        <!-- 底部开始 -->
