    ...
    <div class="news-detail">
        <div class="content">
            <div class="news-title">
                <h1>Cinstar CR4.8 screen walks into Belfast Cathedral church</h1>
                <h2 class="sub-title">Published：2016/10/13</h2>
            </div>
            <div class="content-box">
                <div class="img-box">
                    <img src="../images/news/news20.jpg" alt="Cinstar CR4.8 screen walks into Belfast Cathedral church"/>
                </div>
                <p>
                ...
                <p>
                    Two weeks ago, 40sqm of Cinstar CR4.8 screen attended one story sharing gathering in St Anne’s Cathedral church in Belfast. The LED screen was used to display videos of each speaker’s life recording and sharing to others.
                </p>
            </div>
        </div>
    </div>
    <div class="related-news">
        <h3><span>Previous :</span><a href="2017-1-10.php">130sqm Cinstar VX3.9 participates Missionary Party</a></h3>
        <h3><span>Next :</span><a href="2016-8-23.php">Cinstar outdoor curtain screen decorates COOP Arena</a></h3>
    </div>
        <!-- 底部开始 -->
