...
<body class="page-index .menu-open">
    ...
    <div class="news-detail">
        <div class="content">
            <div class="news-title">
                <h1>The reasons why you need to upgrade your projector & LCD video wall</h1>
    ...
    <h3><span>Previous :</span><a href="2021-7-12.php">Cinstar U1.25 4K UHD LED video screen for home cinema</a></h3>
        <h3><span>Next :</span><a href="2021-4-15.php">Mini LED may lead the LED display technology development</a></h3>
    </div>
        <!-- 底部开始 -->
