    ...
    <div class="news-detail">
        <div class="content">
            <div class="news-title">
                <h1>Cinstar UHD 4K direct view LED for USA home cinema</h1>
            ...
            <div class="content-box">
                ...
                <p>
                Featuring the Black LEDs, Cinstar U series <a href="https://www.cinstar-led.com/products/direct-view-led.php"><b>direct view led display wall</b></a> provides a superior HD image with high contrast ratio 6000:1, high refresh rate to 3840Hz, deep blacks and vibrant colors. High quality image output is guaranteed for TV productions. The pixel pitches range from 0.93mm to 1.87mm.
                </p>
                <p class="desc-title">
                    <b>Seamless Video Splicing Technology</b>
                </p>
                <p>Cinstar U series <a href="https://www.cinstar-led.com/products/direct-view-led.php"><b>direct view led TV</b></a> construction is made of ultra-high precision die-cast aluminum with tolerance < 0.2mm. In addition, it is capable of module-level fine adjustment, which ensures truly seamless connection and excellent image quality.</p>
                <p class="desc-title">
