...
<body class="page-index .menu-open">
    ...
    <div class="news-detail">
        <div class="content">
            <div class="news-title">
                <h1>Infinite potential in led display market</h1>
                <h2 class="sub-title">Published：2018/05/21</h2>
            </div>
            <div class="content-box">
                <div class="img-box">
                    <img src="../images/news/news10.jpg" alt="Infinite potential in led display market"/>
                </div>
                <p>
    ...
    <div class="related-news">
        <h3><span>Previous :</span><a href="2018-6-4.php">45sqm Cinstar LM2.6 stunning performance on Dale Farm’s AGM</a></h3>
        <h3><span>Next :</span><a href="2018-4-12.php">260sqm Cinstar LM3.9 decorates shopping mall</a></h3>
    </div>
        <!-- 底部开始 -->
