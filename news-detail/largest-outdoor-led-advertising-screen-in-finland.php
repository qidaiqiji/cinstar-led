...
<head>
    ...
    <title>Outdoor LED Advertising Screen Display Finland</title>
    ...
    <meta name="description" content="Cinstar collaborated with our Finnish partner installed the largest outdoor LED advertising screen display in Finland.">
</head>
    ...
    <div class="news-detail">
        <div class="content">
            <div class="news-title">
                <h1>The largest outdoor LED advertising screen in Finland</h1>
                <h2 class="sub-title">Published：2022/10/20</h2>
            </div>
