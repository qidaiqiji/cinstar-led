...
<head>
    ...
    <title>Cinstar HD1.25 4K fine pitch LED display ready for shipment to US</title>
    <meta name="description" content="Big thanks to the customers who supported us at this unprecedented period, hope the quarantine time will come to its end soon and everything back to the right track." />
    ...
    <div class="news-detail">
        <div class="content">
            <div class="news-title">
                <h1>Cinstar HD1.25 4K fine pitch LED display ready for shipment to US</h1>
            ...
            <div class="content-box">
                ...
                <div class="img-box" style="width: 70%"> 
                    <img src="../images/news/Cinstar-HD1.25-9x7panels-1.jpg" alt="Cinstar-HD1.25-9x7panels-1"/>
                </div>
                <p>
                ...
                <div class="img-box" style="width: 70%"> 
                    <img src="../images/news/Cinstar-HD1.25-9x7panels-2.jpg" alt="Cinstar-HD1.25-9x7panels-2"/>
                </div> 
                <p>
                ...
                <div class="img-box" style="width: 70%"> 
                    <img src="../images/news/Cinstar-HD1.25-9x7panels-3.jpg" alt="Cinstar-HD1.25-9x7panels-3"/>
                </div> 
                <p>
                ...
                <div class="img-box" style="width: 70%"> 
                    <img src="../images/news/Cinstar-HD1.25-9x7panels-4.jpg" alt="Cinstar-HD1.25-9x7panels-4"/>
                </div>
            </div>
        </div>
    </div>
    <div class="related-news">
        <h3><span>Previous :</span><a href="2020-9-20.php">How to trade in quality LED displays</a></h3>
        <h3><span>Next :</span><a href="2020-3-5.php">Cinstar HD 1.87 ready for shipment to Belgium</a></h3>
    </div>
        <!-- 底部开始 -->
