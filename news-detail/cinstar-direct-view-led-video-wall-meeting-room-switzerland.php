    ...
    <div class="news-detail">
        <div class="content">
            <div class="news-title">
                <h1>Cinstar direct view LED video wall for meeting room Switzerland</h1>
                <h2 class="sub-title">Published：2018/07/19</h2>
            </div>
            <div class="content-box">
                <p>
                    Benefited from technology breakthrough of LED encapsulation, <a href="https://www.cinstar-led.com/products/direct-view-led.php"><b>direct view led video wall</b></a> is now a new trend for LED applications for its higher capacity module and far better resolution. With the technology becoming matured, the market dominated by LCD video wall facing big challenges from LED display. The main competition concentrated on control room, monitor room, TV studio and conference rooms where ultra-high resolution is needed to deliver crystal clear image quality. High brightness, high refresh rate, wide color gamut, low failure rate and truly seamless connection are what the features the LCD can’t compete with.
                </p>
                <p>
