...
<head>
    ...
    <link rel="canonical" href="https://www.cinstar-led.com/news-detail/cinstar-church-led-screen-uk.php">
    <link rel="stylesheet" href="../css/newsDetail-240926.css">
    <title>Church LED Screen UK | Cinstar LED</title>
    <meta name="description" content="40sqm Cinstar church LED screen walks into Belfast Cathedral church for story sharing gathering.">
    ...
    <div class="news-detail">
        <div class="content">
            <div class="news-title">
                <h1>Cinstar church LED screen UK</h1>
                <h2 class="sub-title">Published：2016/10/13</h2>
            </div>
            <div class="content-box">
                ...
                <p>
                    Two weeks ago, 40sqm of Cinstar CR4.8 <a href="https://www.cinstar-led.com/products/church-led-screen.php"><b>church led screen</b></a> attended one story sharing gathering in St Anne’s Cathedral church in Belfast. The LED screen was used to display videos of each speaker’s life recording and sharing to others.
                </p>
            </div>
        </div>
    </div>
