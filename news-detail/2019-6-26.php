...
<body class="page-index .menu-open">
    ...
    <div class="news-detail">
        <div class="content">
            <div class="news-title">
                <h1>Cinstar 40.5sqm fine pitch HD1.56 LED video display to France</h1>
    ...
    <div class="related-news">
        <h3><span>Previous :</span><a href="2019-7-4.php">200sqm Cinstar EC2.9 rental LED video display ready for shipment to USA</a></h3>
        <h3><span>Next :</span><a href="2019-5-23.php">Cinstar launched its most practical rental LED display</a></h3>
    </div>
        <!-- 底部开始 -->
