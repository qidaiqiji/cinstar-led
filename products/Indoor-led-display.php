...
<body class="page-index">
    ...
    <div class="new-product-container">
        ...
        <div class="product-banner" style="height: 8rem">
            <img src="../images/products/new-page/Indoor-led-display/indoor-led-display-1.webp" alt="indoor led display-1"/>
            ...
            <div class="content series-list-content">
                ...
                <div class="series-box">
                    <div class="series-item">
                        <a class="img-box" href="../product-detail/m-series.php"><img style="width: 70%;" src="../images/products/Rental-LED/M-series-1.webp" alt="M series" /></a>
                    ...
                    <div class="series-item">
                        <a class="img-box" href="../product-detail/ch-series.php"><img style="width: 80%;" src="../images/products/Fine-Pitch/CH-series-1.webp" alt="CH SERIES" /></a>
                        <div class="title-box-change">
                    ...
                    <div class="series-item">
                        <a class="img-box" href="../product-detail/fl-series.php"><img style="width: 70%;" src="../images/products/Commercial-LED/FL-series-1.jpg" alt="FL SERIES" /></a>
                        <div class="title-box-change">
        ...
        <div class="spec-content choose-content">
            <div class="content">
                ...
                <div class="img-box">
                    <img src="../images/products/new-page/Indoor-led-display/indoor-led-display-2.jpg" alt="indoor led display-2" />
                    <img src="../images/products/new-page/Indoor-led-display/indoor-led-display-3.jpg" alt="indoor led display-3" />
                </div>
                ...
                <div class="img-box" style="justify-content: center">
                    <img style="width: 70%" src="../images/products/new-page/Indoor-led-display/indoor-led-display-4.jpg" alt="indoor led display-4" />
                </div>
            </div>
        </div>
        <div class="spec-content blog-content content-container">
            <div class="content">
                ...
                <div class="img-box">
                    <img src="../images/products/new-page/Indoor-led-display/indoor-led-display-5.jpg" alt="indoor led display-5" />
                </div>
                ...
                <div class="img-box">
                    <img src="../images/products/new-page/Indoor-led-display/indoor-led-display-6.jpg" alt="indoor led display-6" />
                </div>
                ...
                <div class="img-box">
                    <img src="../images/products/new-page/Indoor-led-display/indoor-led-display-7.jpg" alt="indoor led display-7" />
                </div>
                ...
                <div class="img-box">
                    <img src="../images/products/new-page/Indoor-led-display/indoor-led-display-8.jpg" alt="indoor led display-8" />
                </div>
                ...
                <div class="img-box">
                    <img src="../images/products/new-page/Indoor-led-display/indoor-led-display-9.jpg" alt="indoor led display-9" />
                </div>
                ...
                <div class="img-box">
                    <img src="../images/products/new-page/Indoor-led-display/indoor-led-display-10.jpg" alt="indoor led display-10" />
                </div>
                <h3 class="chapter-title" id="chapter4">Chapter 4  Applications of Indoor LED Display</h3>
                <div class="img-box">
                    <img src="../images/products/new-page/Indoor-led-display/indoor-led-display-11.jpg" alt="indoor led display-11" />
                </div>
                ...
                <div class="img-box">
                    <img src="../images/products/new-page/Indoor-led-display/indoor-led-display-12.jpg" alt="indoor led display-12" />
                </div>
                ...
                <div class="img-box">
                    <img src="../images/products/new-page/Indoor-led-display/indoor-led-display-13.jpg" alt="indoor led display-13" />
                </div>
                ...
                <div class="img-box">
                    <img src="../images/products/new-page/Indoor-led-display/indoor-led-display-14.jpg" alt="indoor led display-14" />
                </div>
