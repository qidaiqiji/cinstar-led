    ...
    <div class="container">
        ...
        <div class="sort-box">
            ...
            <div class="sort-list">
                <div class="sort-item">
                    <div class="sort-img">
                        <a href="../products/custom-led.php"><img src="../images/products/product-home/products-custom.jpeg"></a>
                    </div>
                    <div class="sort-detail">
                        <div class="sub-title">
                            <h3><a href="../products/custom-led.php">Custom LED Display</a></h3>
                        </div>
                        ...
                        <div>
                            <a class="read-more" href="../products/custom-led.php"><i class="fa fa-caret-right right"></i>Read More</a>
                        </div>
                    </div>
                </div>
                <hr class="under-line"/>
